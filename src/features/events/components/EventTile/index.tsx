        ...
        <div className='event-tile'>
            <div className='event-tile__left-side'>
                <div className='event-tile__title'>
                    {name} {statusCode != null && <Chip className='event-tile__chip' label={EVENT_STATUS[statusCode]} color={EVENT_STATUS_COLOR[EVENT_STATUS[statusCode]]} />}
                </div>
            ...
            <div className='event-tile__right-side'>
                ...
                <div className='event-tile__button'>
                    <CommonButton color='success' startIcon={<ShareIcon />}>Share</CommonButton>
                </div>
            </div>
        </div>
    );
